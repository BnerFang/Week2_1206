...
public class RegModel {
    ...
    public void reg(String mobile, String password, final LoginAndRegCallBack callBack) {
        String loginPath = "http://www.zhaoapi.cn/user/reg?mobile="+mobile+"&password="+ password;
